...
class DepositCoupons extends BaseModel {

    public static $resourceName = 'DepositCoupons';
...
//    public static $mainParamColumn = 'parent_id';
    ...
    protected $table = 'deposit_coupons';
    ...
    protected function beforeValidate() {
        if (!$this->code) {
            $sCode = substr(md5('dc'.$this->id . time() . random_str(5)), 0, 8);
            $this->code = $sCode;
        }
